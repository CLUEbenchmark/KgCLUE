...
class NerPredict(object):
    ...
    def __init__(self, MODEL_PATH):
        ...
        self.data_making = NerDataMaking(do_lower_case=True, max_seq_length=config.max_seq_length)
    ...
    def predict_one(self, PREDICT_TXT, EVAL_MODE=False):

        feature = self.data_making.convert_single_example(PREDICT_TXT, test_mode=True)
...
if __name__ == '__main__':
    ...
    PREDICT_TXT = "你知道长江武汉航道局管多少个地方吗？"

    ner = NerPredict(MODEL_PATH)
    print("test predict: ", ner.predict_one(PREDICT_TXT, EVAL_MODE=True))
