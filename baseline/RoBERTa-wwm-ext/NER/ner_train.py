...
config = {
    "in_1": r"C:\Users\11943\Documents\GitHub\RoBERTa-wwm-ext\NER\data\train\train.tf_record",  # 第一个输入为 训练文件
    "in_2": r"C:\Users\11943\Documents\GitHub\RoBERTa-wwm-ext\NER\data\eval\eval.tf_record",  # 第二个输入为 验证文件
    "bert_config": cf.bert_config,  # bert模型配置文件
    "init_checkpoint": cf.init_checkpoint,  # 预训练bert模型
    "vocab_file": cf.vocab_file,
    "train_examples_len": cf.ner_train_nums,
    "dev_examples_len": cf.ner_valid_nums,
    "num_labels": len(cf.token_label_list),
    "train_batch_size": 16,
    "dev_batch_size": 16,
    "num_train_epochs": 5,
    "eval_start_step": 400,
    ...
    "out": "./NER/model/",  # 保存模型路径
    "out_1": "./NER/model/",  # 保存模型路径
    "train_out": "./NER/train_out/"
}
